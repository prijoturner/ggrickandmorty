    ...
    private func bindViewModel() {
        ...
        viewModel.$displayLocations
            ...
            .sink { [weak self] locations in
                ...
                if locations.isEmpty && !self.viewModel.isLoading {
...
extension LocationViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let locationData = viewModel.location(at: indexPath.row)
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        let location = viewModel.getOriginalLocation(at: indexPath.row)
        ...
        locationDetailVC.viewModel.location = location
...
extension LocationViewController: UISearchBarDelegate {
    func searchBar(_ searchBar: UISearchBar, textDidChange searchText: String) {
        ...
        viewModel.searchForLocations(with: searchText, isActive: isActive)
    }
